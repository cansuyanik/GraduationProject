...
def create_weight_matrix_bert(word2idx, n_words, vector_dimension = 768):
    ...
    for word, i in word2idx.items():
        ...
        with torch.no_grad():
            ...
            embedding_vector = list(x[0][0].cpu().numpy())
            print(word)
            print(i)
...
embedding_matrix = create_weight_matrix_bert(word2idx, n_words)

model_name1 = 'pre-trained-rnn-bi_bert'
model_name2 = 'pre-trained-rnn-3layer_bert'
model_name3 = 'pre-trained-rnn-dif_parameters_bert'
...
predict(model3, words, tags, exampleSentence, word2idx, MAX_LEN, n_words)
